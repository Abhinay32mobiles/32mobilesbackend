...
class ModelDetails(models.Model):
    ...
    img2 = models.URLField(max_length=500, blank=False, null=False)
    img3 = models.URLField(max_length=500, blank=False, null=False)
    img4 = models.URLField(max_length=500, blank=False, null=False)

...
class ModelDetails(models.Model):
    ...
    warranty_duration = models.TextField(null=True, blank=True)
    ...
    antutu_score = models.PositiveIntegerField(null=True, blank=True)
    antutu_desc = models.TextField(null=True, blank=True)
